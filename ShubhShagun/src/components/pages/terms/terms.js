  ...
  return (
    <div className="term">
      ...
      <p>
        ...
        of Shubh Shagun's Website, located at shubhshagun.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use ShubhShagun if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing ShubhShagun, you agreed to
        use cookies in agreement with the Shubh Shagun's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Shubh Shagun and/or its licensors own the
        intellectual property rights for all material on ShubhShagun. All
        intellectual property rights are reserved. You may access this from
        ShubhShagun for your own personal use subjected to restrictions set in
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Shubh
        Shagun does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Shubh Shagun,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Shubh Shagun shall not be liable
      ...
      <p>
        Shubh Shagun reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Shubh Shagun a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Shubh Shagun; and (d) the link
      ...
      <p>
        ...
        e-mail to Shubh Shagun. Please include your name, your organization
      ...
      <p>
        No use of Shubh Shagun's logo or other artwork will be allowed for
